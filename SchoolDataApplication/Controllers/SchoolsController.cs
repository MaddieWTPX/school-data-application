...
//        public SchoolsController(SchoolDataApplicationDbContext context)
//        {
//            _context = context;
//        }
...
//                          Problem("Entity set 'SchoolDataApplicationDbContext.Schools'  is null.");
//        }
...
//        public async Task<IActionResult> Create([Bind("SchoolId,Name,Address")] School school)
//        {
...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public async Task<IActionResult> Edit(int id, [Bind("SchoolId,Name,Address")] School school)
//        {
...
//            {
//                return Problem("Entity set 'SchoolDataApplicationDbContext.Schools'  is null.");
//            }
//            var school = await _context.Schools.FindAsync(id);
//            if (school != null)
//            {
