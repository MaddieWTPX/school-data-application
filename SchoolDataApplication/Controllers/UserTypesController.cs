...
namespace SchoolDataApplication.Controllers
{
    public class UserTypesController : Controller
    {
        ...
        public UserTypesController(SchoolDataApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserTypes != null ? 
                          ...
                          Problem("Entity set 'SchoolDataApplicationDbContext.UserTypes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("UserTypeId,Name")] UserType userType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserTypeId,Name")] UserType userType)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SchoolDataApplicationDbContext.UserTypes'  is null.");
            }
            var userType = await _context.UserTypes.FindAsync(id);
            if (userType != null)
            {
